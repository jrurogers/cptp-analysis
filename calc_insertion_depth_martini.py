...
"""
calc_insertion_depth_martini.py gro xtc
...
def main():
   ...
   u.trajectory[0]
   top=u.select_atoms('resid 215:346')
   bot=u.select_atoms('resid 347:478')
   prot=u.select_atoms('resid 1:214')
   box=u.dimensions
   ...
   # phosphate selection
   if topref:
      po4 = top.select_atoms('name PO4')
   else:
      po4 = bot.select_atoms('name PO4')
